...
5. Render `html_content` as the article body and use `meta_title`, `meta_description`, `cover_image_url`, `canonical_url`, `published_at`, `author`, and `category` for page metadata and UI.
...
- `GET /api/integration/sites/{site_slug}/posts?limit=20&offset=0`
